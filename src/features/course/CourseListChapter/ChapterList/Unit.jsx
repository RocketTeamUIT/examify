  ...
  return (
    <a href="#/" className="">
      <div className="flex items-center justify-between h-[60px] bg-bg_light_gray shadow-md rounded-md px-4">
        <p className="">
          <span className="text-body-sm md:text-body-md">{unit.id}. </span>
          <span className="text-body-sm md:text-body-md">{unit.name}</span>
        </p>
        <div className="flex items-center gap-4">
          <span className="hidden text-t_gray md:block">{unit.totalLesson} bài giảng</span>
          {progress === 0 && lockItem()}
